...
const nwt={
  ...
  //////////////////////////////////////////
  //
  // isPerson: true if the name is in the 
  //           list of people's names
  //
  //////////////////////////////////////////
  isPerson:function(name){
    return nwt.map.people[name];
  },
  /////////////////////////////////////////
  //
  // splitToMetaWords
  ...
  splitToMetaWords:function(input){
    ...
    for(let word of words){
      ...
      mw.isPerson       = nwt.isPerson( mw.atomic );
      metaWords.push( mw );
    }
    return metaWords; 
  },
